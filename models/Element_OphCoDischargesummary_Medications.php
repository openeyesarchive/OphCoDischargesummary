...
/**
 * This is the model class for table "et_ophcodischargesummary_medications".
 *
 * The followings are the available columns in table:
 * @property string $id
 * @property integer $event_id
 * @property integer $medications_unchanged
 *
...
class Element_OphCoDischargesummary_Medications extends BaseEventTypeElement
{
	public $service;
	...
	{
		return 'et_ophcodischargesummary_medications';
	}
	...
	public function rules()
	{
		...
		return array(
			array('event_id, medications_unchanged, ', 'safe'),
			array('medications_unchanged, ', 'required'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, event_id, medications_unchanged, ', 'safe', 'on' => 'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'id' => 'ID',
			'event_id' => 'Event',
			'medications_unchanged' => 'Pre admission systemic medications unchanged',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('medications_unchanged', $this->medications_unchanged);
