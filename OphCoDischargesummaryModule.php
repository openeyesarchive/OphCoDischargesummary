...
class OphCoDischargesummaryModule extends BaseEventTypeModule
{
	...
	public function init()
	{
		...
		$this->setImport(array(
			'OphCoDischargesummary.models.*',
			'OphCoDischargesummary.components.*',
		));

		$this->moduleShortSuffix = "dischargesummary";
	}
