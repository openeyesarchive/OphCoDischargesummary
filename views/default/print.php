...
<div>
	<table cellspacing="0" width="1000">
		<tbody>
			<tr>
				<td align="left" width="20%"><?php echo CHtml::image(Yii::app()->getAssetManager()->publish(Yii::getPathOfAlias('OphCoDischargesummary.assets')).'/img/logo1.jpg'); ?></td>
				<td align="left" width="45%"><h1 style="margin-top:40px;">Discharge summary</h1></td>
