...
<table class="subtleWhite normalText">
	<tbody>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('local_name'))?></td>
		...
		<tr>
			...
			<td><span class="big"><?php echo CHtml::encode($element->local_location)?></span></td>
		</tr>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('orbis_name'))?></td>
		...
		<tr>
			...
			<td><span class="big"><?php echo CHtml::encode($element->orbis_location)?></span></td>
		</tr>
	</tbody>
</table>
